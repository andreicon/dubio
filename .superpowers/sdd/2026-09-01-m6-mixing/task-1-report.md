...
- Fixed the Demucs smoke-test stub to include `model.sources` so it matches the adapter contract.
...
- Re-ran syntax verification after the fixture-only fix with `python3.12 -m compileall src tests`.
